...
- 앱을 열 때마다 새 일기로 시작하며, 작성 중이던 작업은 자동으로 복원하지 않습니다.
- 완성한 일기는 날짜별 최대 2개까지 기기에 보관됩니다.
- 보관한 일기는 다른 기기와 동기화되지 않으며 앱 데이터를 삭제하면 사라질 수 있습니다.
- 공유할 때는 완성 이미지가 아닌 앱 소개 문구와 미니앱 링크를 전달합니다.
